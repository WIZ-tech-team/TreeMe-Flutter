...
class _InputCustomWidgetState extends State<InputCustomWidget> {
  ...
  bool recordButtonVisible = false;
  ...
  Widget _inputBuilder() {
    ...
    final buttonPadding =
        InheritedChatTheme.of(context).theme.inputPadding.copyWith(left: 16, right: 16);
    final safeAreaInsets = isMobile
        ...
        : EdgeInsets.zero;
    final textPadding =
        InheritedChatTheme.of(context).theme.inputPadding.copyWith(left: 0, right: 0).add(
              EdgeInsets.fromLTRB(
  ...
  @override
  void didUpdateWidget(covariant InputCustomWidget oldWidget) {
