...
class TypeWiththemeScreen extends StatelessWidget {
                ...
                slivers: [
                            ...
                            Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(AppStrings.chooseYourEvent,
                                    style: getBoldStyle(
                  ...
                  SliverToBoxAdapter(
                    child:ListView.builder(
                      ...
                      itemCount: logic.eventTypeModel.length,
                      itemBuilder: (context, index) {
                      return TypeThemeWidgets(eventTypeModel: logic.eventTypeModel[index],);
