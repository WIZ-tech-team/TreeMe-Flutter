...
class Themes {
  static final light = ThemeData.light().copyWith(
    ...
    // drawerTheme: const DrawerThemeData(backgroundColor: AppColors.lightMainColor),
    ...
    // cardColor: AppColors.lightBoxShadow,
  );
  ...
  //   cardColor: AppColors.darkBoxShadow,
  //   primaryColor: const Color(0XFF181D23),
